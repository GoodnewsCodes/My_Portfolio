...
## Project Structure
The website is a single HTML file with embedded CSS & JavaScript for simplicity. All styling is contained within the `<style>` tags and scripting is done in the `<script>` tags in the document head.
...
4. Use contact links to reach out to me via email or social platforms
